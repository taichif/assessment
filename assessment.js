(function(){
    ...
    const assenssmentButton = document.getElementById('assessment');
    const resultDivided = document.getElementById('result-area');
    const tweetDivided = document.getElementById('tweet-area');

    function removeAllChilldren(element) {
    ...
    assenssmentButton.onclick = () => {
        ...
        removeAllChilldren(resultDivided);
        ...
        removeAllChilldren(tweetDivided);
